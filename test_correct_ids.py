#!/usr/bin/env python3
"""
올바른 ClientId/ClientServiceId 조합 테스트
ClientId = PersonId, ClientServiceId = MainClientServiceId
"""
...
test_data = {
    ...
    "NotesPlainText": "올바른 ClientId/ClientServiceId 조합 테스트 - Doctor 이벤트 - Mrs Phoebe Smith",
    "CreatedByUser": {
        "FirstName": "Test",
        "LastName": "User",
        "UserName": "testuser",
...
def test_api():
    ...
    print("올바른 ClientId/ClientServiceId 조합으로 Progress Note API 테스트 중...")
    print(f"URL: {url}")
    ...
    try:
        ...
        if response.status_code == 200:
            print("\n✅ SUCCESS: 올바른 ClientId/ClientServiceId 조합으로 API 호출 성공!")
        else:
